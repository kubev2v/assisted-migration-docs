...
The data fields and structure described in this document may vary between releases. New fields may be added, deprecated fields may be removed, and the exact data collected may differ based on your VMware environment configuration, the collection method used (Discovery Agent vs RVTools), and the version of the Migration Advisor tool.

**Note:** The team does not promise that the data described in this document will align with the latest release. This information will be updated from time to time.
...
#### CPU Tier Distribution (`distributionByCpuTier`)
...
#### Memory Tier Distribution (`distributionByMemoryTier`)
...
#### NIC Count Distribution (`distributionByNicCount`)
...
#### Not Migratable Reasons (`notMigratableReasons`)
...
### Host Power States (`hostPowerStates`)
...
### Datastore Information (`datastores`)
...
The inventory data can be collected through two methods:

### 1. Discovery Agent (OVA)
